...
Strong, unique passwords for every website and app is critical to everyone's security, for both users and companies. With direct 1Password integration, we can encourage all our users to avoid shortcuts, stay secure, and make the world a better place.
...
To get started, download the 1Password Extension Demo project from https://github.com/AgileBits/onepassword-extension/archive/master.zip, or [clone it from GitHub](https://github.com/AgileBits/onepassword-extension).
...
### Scenario 1: Filling Logins

Here we'll learn how to enable your existing users to fill their credentials into your login form using 1Password.
...
The first thing you'll need to do is add a UIButton to your login page. Use an existing image from the `Resources/Images` folder.

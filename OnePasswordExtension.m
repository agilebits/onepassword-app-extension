...
''):null;return[b?b:null,a.value]}),{options:a}):null}function W(a){switch(e(a.type)){case 'checkbox':return a.checked?'✓':'';case 'hidden':a=a.value;if(!a||'number'!=typeof a.length)return'';254<a.length&&(a=a.substr(0,254)+'...SNIPPED');return a;case 'submit':case 'button':case 'reset':if(''===a.value)return n(p(a))||'';default:return a.value}}function X(a,b){if(-1===['text','password'].indexOf(b.type.toLowerCase())||!(k.test(a.value)||k.test(a.htmlID)||k.test(a.htmlName)||k.test(a.placeholder)||\
k.test(a['label-tag'])||k.test(a['label-data'])||k.test(a['label-aria'])))return!1;if(!a.visible)return!0;if('password'==b.type.toLowerCase())return!1;a=b.type;t(b,!0);return a!==b.type}function Y(a){var b={};a.forEach(function(a){b[a.opid]=a});return b}function h(a,b){var c=a[b];if('string'==typeof c)return c;a=a.getAttribute(b);return'string'==typeof a?a:null}function G(a){return'input'===a.nodeName.toLowerCase()&&-1===a.type.search(/button|submit|reset|hidden|checkbox/i)}var w={},k=/((\\b|_|-)pin(\\b|_|-)|password|passwort|kennwort|(\\b|_|-)passe(\\b|_|-)|contraseña|senha|密码|adgangskode|hasło|wachtwoord)/i;\
this.collect=this.b=function(a,c){w={};var f=a.defaultView?a.defaultView:b,k=a.activeElement,V=Array.prototype.slice.call(g(a,'form')).map(function(a,b){var c={};b='__form__'+b;a.opid=b;c.opid=b;d(c,'htmlName',h(a,'name'));d(c,'htmlID',h(a,'id'));d(c,'htmlAction',m.a.g(h(a,'action')));d(c,'htmlMethod',h(a,'method'));return c}),K=u(a).map(function(a,b){G(a)&&a.hasAttribute('value')&&!a.dataset['com.agilebits.onepassword.initialValue']&&(a.dataset['com.agilebits.onepassword.initialValue']=a.value);\
...
function aa(){var a=/((\\b|_|-)pin(\\b|_|-)|password|passwort|kennwort|passe|contraseña|senha|密码|adgangskode|hasło|wachtwoord)/i;return Array.prototype.slice.call(N(document,\"input[type='text']\")).filter(function(b){return b.value&&a.test(b.value)},this)}function ba(){aa().forEach(function(a){B(a);a.click&&a.click();C(a)})}\
...
(window.innerHeight-b)/2:c.height/2));c&&c!==a&&c!==document;){if(c.tagName&&'string'===typeof c.tagName&&'label'===c.tagName.toLowerCase()&&a.labels&&0<a.labels.length)return 0<=Array.prototype.slice.call(a.labels).indexOf(c);c=c.parentNode}return c===a}function J(a){return O&&v(a)?-1!=='email text password number tel url'.split(' ').indexOf(a.type||''):!1}function u(a){return Array.prototype.slice.call(N(a,'input, select, button'))}\
function L(a){var b;if(void 0===a||null===a)return null;if(b=FieldCollector.c(a))return b;try{var c=u(document),e=c.filter(function(b){return b.opid==a});if(0<e.length)b=e[0],1<e.length&&console.warn('More than one element found with opid '+a);else{var d=parseInt(a.split('__')[1],10);isNaN(d)||(b=c[d])}}catch(g){console.error('An unexpected error occurred: '+g)}finally{return b}};function N(a,b){var c=[];try{c=a.querySelectorAll(b)}catch(e){console.error('[COMMON] Exception processing selector \"'+b+'\"')}return c}function t(a,b){if(!a)return!1;var c;b&&(c=a.value);'function'===typeof a.click&&a.click();'function'===typeof a.focus&&a.focus();b&&a.value!==c&&(a.value=c);return'function'===typeof a.click||'function'===typeof a.focus};var H=!0,O=!0,F=!0;function ca(a){return a?0===a.indexOf('https://')&&'http:'===document.location.protocol&&(a=document.querySelectorAll('input[type=password]'),0<a.length&&(confirmResult=confirm('1Password warning: This is an unsecured HTTP page, and any information you submit can potentially be seen and changed by others. This Login was originally saved on a secure (HTTPS) page.\\n\\nDo you still wish to fill this login?'),0==confirmResult))?!0:!1:!1}\
function P(a){var b,c=[],e=a.properties,d=1,g=[];e&&e.delay_between_operations&&(d=e.delay_between_operations);if(!ca(a.savedURL)){var l=function(a,b){var c=a[0];if(void 0===c)b();else{if('delay'===c.operation||'delay'===c[0])d=c.parameters?c.parameters[0]:c[1];else if(c=da(c))for(var e=0;e<c.length;e++)-1===g.indexOf(c[e])&&g.push(c[e]);setTimeout(function(){l(a.slice(1),b)},d)}};H=F=!0;if(b=a.options)b.hasOwnProperty('animate')&&(O=b.animate),b.hasOwnProperty('markFilling')&&(H=b.markFilling);if((b=\
...
{documentUUID:documentUUID,context:a.fillContextIdentifier,filledOpids:c},function(){fillingItemType=null})})}}var Z={fill_by_opid:Q,fopid:Q,fill_by_query:R,fq:R,click_on_opid:S,copid:S,click_on_query:T,cq:T,touch_all_fields:ea,simple_set_value_by_query:fa,focus_by_opid:U,focusopid:U,delay:null};\
function da(a){var b;if(a.hasOwnProperty('action')&&a.hasOwnProperty('values'))b=a.action,a=a.values;else if('[object Array]'===Object.prototype.toString.call(a))b=a[0],a=a.splice(1);else return null;return Z.hasOwnProperty(b)?Z[b].apply(this,a):null}function Q(a,b){return(a=L(a))?(E(a,b),[a]):null}function R(a,b){a=N(document,a);return Array.prototype.map.call(Array.prototype.slice.call(a),function(a){E(a,b);return a},this)}\
function fa(a,b){var c=[];a=N(document,a);Array.prototype.forEach.call(Array.prototype.slice.call(a),function(a){a.disabled||a.f||a.readOnly||void 0===a.value||(a.value=b,c.push(a))});return c}function U(a){(a=L(a))&&t(a,!0);return null}function S(a){return(a=L(a))?t(a,!1)?[a]:null:null}function T(a){a=N(document,a);return Array.prototype.map.call(Array.prototype.slice.call(a),function(a){t(a,!0);return[a]},this)}function ea(){ba()};window.addEventListener('$SECURITY_TOKEN',function(a){switch(a.detail.name){case 'executeFillScript':a=a.detail.payload.scripts instanceof Array?a.detail.payload.scripts:[a.detail.payload];for(var b=0;b<a.length;b++)P(a[b]);window.webkit.messageHandlers.$SECURITY_TOKEN.postMessage({name:'fillItemResults',payload:{j:!0}});break;case 'collectDocuments':window.webkit.messageHandlers.$SECURITY_TOKEN.postMessage({name:'collectFieldsResult',payload:FieldCollector.b(document,'oneshotUUID')});break;default:console.error('[END] Unhandled message: %s',\
a.detail.name)}},!1);\
\
})(document);\
\

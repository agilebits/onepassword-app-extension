...
- (void)changePasswordForLoginForURLString:(nonnull NSString *)URLString loginDetails:(nullable NSDictionary *)loginDetailsDict passwordGenerationOptions:(nullable NSDictionary *)passwordGenerationOptions forViewController:(UIViewController *)viewController sender:(nullable id)sender completion:(nullable void (^)(NSDictionary * __nullable loginDictionary, NSError * __nullable error))completion {
	NSAssert(URLString != nil, @"URLString must not be nil");
	NSAssert(viewController != nil, @"viewController must not be nil");
...
static NSString *const OPWebViewCollectFieldsScript = @";(function(document, undefined) {if(Object.getOwnPropertyDescriptor(document,\"com_agilebits_onepassword_collect\")&&!Object.getOwnPropertyDescriptor(document,\"com_agilebits_onepassword_collect\").writable){console.error(\"The page at \"+document.location.href+\" defines com_agilebits_onepassword_collect as a read-only property. Assume malicious intent.\");alert(\"1Password is not able to properly interact with this page.\\nPlease send the address of this page to support@agilebits.com so we can further investigate.\");return;}document.com_agilebits_onepassword_collect=n;document.elementsByOPID={};\
...
static NSString *const OPWebViewFillScript = @"(function(document, fillScript, undefined) {if(Object.getOwnPropertyDescriptor(document,\"com_agilebits_onepassword_fill\")&&!Object.getOwnPropertyDescriptor(document,\"com_agilebits_onepassword_fill\").writable){console.error(\"The page at \"+document.location.href+\" defines com_agilebits_onepassword_fill as a read-only property. Assume malicious intent.\");alert(\"1Password is not able to properly interact with this page.\\nPlease send the address of this page to support@agilebits.com so we can further investigate.\");return;}var f=!0,h=!0;document.com_agilebits_onepassword_fill=k;\
...
document.com_agilebits_onepassword_fill(fillScript); return JSON.stringify({'success': true}); })";

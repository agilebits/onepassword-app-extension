...
// Errors
FOUNDATION_EXPORT NSString *const OPAppExtensionErrorDomain;
FOUNDATION_EXPORT NSInteger const OPAppExtensionErrorCodeCancelledByUser;

FOUNDATION_EXPORT NSInteger const OPAppExtensionErrorCodeAPINotAvailable;
FOUNDATION_EXPORT NSInteger const OPAppExtensionErrorCodeFailedToContactExtension;
FOUNDATION_EXPORT NSInteger const OPAppExtensionErrorCodeFailedToLoadItemProviderData;
FOUNDATION_EXPORT NSInteger const OPAppExtensionErrorCodeCollectFieldsScriptFailed;
FOUNDATION_EXPORT NSInteger const OPAppExtensionErrorCodeFillFieldsScriptFailed;
FOUNDATION_EXPORT NSInteger const OPAppExtensionErrorCodeUnexpectedData;
